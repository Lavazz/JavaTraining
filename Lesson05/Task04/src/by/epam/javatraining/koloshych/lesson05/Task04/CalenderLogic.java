...
public class CalenderLogic {
    ...
    public static int giveNewDay(int day, int month, int year) {
        final int APRIL_DAY = 30;
        final int FEBRUARY_LEAP_DAY = 29;
        final int FEBRUARY_USUAL_DAY = 28;
        ...
        switch (month) {
            ...
            case 6:
            case 9:
            case 11: lastDay = APRIL_DAY; break;
            case 2:
                switch (year % 4) {
                    case 1:
                    case 2:
                    case 3: lastDay = FEBRUARY_USUAL_DAY; break;
                    case 0:
                        if (year % 400 == 0) {
                            lastDay = FEBRUARY_LEAP_DAY;
                            break;
                        } else if (year % 100 == 0) {
                            lastDay = FEBRUARY_USUAL_DAY;
                            break;
                        } else {
                            lastDay = FEBRUARY_LEAP_DAY;
                            break;
